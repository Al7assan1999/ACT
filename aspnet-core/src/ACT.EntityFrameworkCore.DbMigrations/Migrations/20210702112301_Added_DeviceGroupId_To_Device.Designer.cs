...
{
    [DbContext(typeof(ACTMigrationsDbContext))]
    [Migration("20210702112301_Added_DeviceGroupId_To_Device")]
    partial class Added_DeviceGroupId_To_Device
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACT.DeviceGroups.DeviceGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDeviceGroups");
                });

            modelBuilder.Entity("ACT.Devices.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ACT.Devices.Device", b =>
                {
                    b.HasOne("ACT.DeviceGroups.DeviceGroup", null)
                        .WithMany()
